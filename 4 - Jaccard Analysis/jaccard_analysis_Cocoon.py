...
df = pd.read_csv('target_Cocoon.csv')

key_column = 'CREATION_DATE'
...
write.to_csv('weight_list_Cocoon.csv', index = False, sep=';', encoding='utf-8')
...
write = pd.DataFrame(zipped,columns = column_names)
write.to_csv('Jac_list_Cocoon.csv', index = False, sep=';', encoding='utf-8')